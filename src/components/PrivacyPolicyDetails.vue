...
<template>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p>The last update: May 01, 2022</p>
        <p>Welcome to the Disposable Vape Kits Privacy Policy.</p>
        <p>
          Disposable Vape Kits respects your privacy and is committed to
        ...
        <p>
          Disposable Vape Kits (“us”, “we”, or “our”) operates the
          https://e-commerce-3ec83.web.app website (hereinafter referred to as
          the “Service”).
        </p>
        <p>
        ...
        <ul>
          <li>
            <b>Service –</b> Service is the https://e-commerce-3ec83.web.app
            website operated by Disposable Vape Kits.
          </li>
          <li>
          ...
          <li>
            <b>Cookies –</b> Cookies are small files stored on your device
            (computer or mobile device).
          </li>
          <li>
            <b>Data Controller –</b> Data Controller means the natural or legal
          ...
          <li>
            <b>Data Processors (or Service Providers) –</b> Data Processor (or
            Service Provider) means any natural or legal person who processes
            the data on behalf of the Data Controller. We may use the services
            of various Service Providers in order to process your data more
            effectively.
          </li>
          <li>
            <b>Data Subject (or User) –</b> Data Subject is any living
        ...
        <p>
          Disposable Vape Kits uses the collected data for various purposes:
        </p>
        <ul>
        ...
        <p>
          If you are from the European Economic Area (EEA), Disposable Vape Kits
        ...
        <p>
          Disposable Vape Kits will retain your Personal Data only for as long
        ...
        <p>
          Disposable Vape Kits will also retain Usage Data for internal analysis
        ...
        <p>
          Disposable Vape Kits will take all the steps reasonably necessary to
        ...
        <p>
          Under certain circumstances, Disposable Vape Kits may be required to
        ...
        <p>
          Disposable Vape Kits may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation.</li>
          <li>
            To protect and defend the rights or property of Disposable Vape Kits
          </li>
          <li>
        ...
        <p>
          ...
          certain data protection rights. Disposable Vape Kits aims to take
        ...
        <ul>
          ...
          <li>
            ...
            withdraw your consent at any time where Disposable Vape Kits relied
        ...
        <ul>
          <li>
            <b>Stripe –</b> Their Privacy Policy can be viewed by clicking
